...
// Validate checks the field values on MatchSegmentRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *MatchSegmentRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on MatchSegmentRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// MatchSegmentRequestMultiError, or nil if none found.
func (m *MatchSegmentRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *MatchSegmentRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetFields() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, MatchSegmentRequestValidationError{
						field:  fmt.Sprintf("Fields[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return MatchSegmentRequestValidationError{
					field:  fmt.Sprintf("Fields[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return MatchSegmentRequestMultiError(errors)
	}

	return nil
}

// MatchSegmentRequestMultiError is an error wrapping multiple validation
// errors returned by MatchSegmentRequest.ValidateAll() if the designated
// constraints aren't met.
type MatchSegmentRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m MatchSegmentRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m MatchSegmentRequestMultiError) AllErrors() []error { return m }

// MatchSegmentRequestValidationError is the validation error returned by
// MatchSegmentRequest.Validate if the designated constraints aren't met.
type MatchSegmentRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e MatchSegmentRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MatchSegmentRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MatchSegmentRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MatchSegmentRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MatchSegmentRequestValidationError) ErrorName() string {
	return "MatchSegmentRequestValidationError"
}

// Error satisfies the builtin error interface
func (e MatchSegmentRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sMatchSegmentRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = MatchSegmentRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = MatchSegmentRequestValidationError{}

// Validate checks the field values on MatchSegmentResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *MatchSegmentResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on MatchSegmentResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// MatchSegmentResponseMultiError, or nil if none found.
func (m *MatchSegmentResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *MatchSegmentResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetResults() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, MatchSegmentResponseValidationError{
			...
			if err := v.Validate(); err != nil {
				return MatchSegmentResponseValidationError{
					field:  fmt.Sprintf("Results[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return MatchSegmentResponseMultiError(errors)
	}

	return nil
}

// MatchSegmentResponseMultiError is an error wrapping multiple validation
// errors returned by MatchSegmentResponse.ValidateAll() if the designated
// constraints aren't met.
type MatchSegmentResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m MatchSegmentResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m MatchSegmentResponseMultiError) AllErrors() []error { return m }

// MatchSegmentResponseValidationError is the validation error returned by
// MatchSegmentResponse.Validate if the designated constraints aren't met.
type MatchSegmentResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e MatchSegmentResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MatchSegmentResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MatchSegmentResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MatchSegmentResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MatchSegmentResponseValidationError) ErrorName() string {
	return "MatchSegmentResponseValidationError"
}

// Error satisfies the builtin error interface
func (e MatchSegmentResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sMatchSegmentResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = MatchSegmentResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = MatchSegmentResponseValidationError{}

// Validate checks the field values on MatchSegmentKeyRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *MatchSegmentKeyRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on MatchSegmentKeyRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// MatchSegmentKeyRequestMultiError, or nil if none found.
func (m *MatchSegmentKeyRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *MatchSegmentKeyRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetFields() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, MatchSegmentKeyRequestValidationError{
						field:  fmt.Sprintf("Fields[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return MatchSegmentKeyRequestValidationError{
					field:  fmt.Sprintf("Fields[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return MatchSegmentKeyRequestMultiError(errors)
	}

	return nil
}

// MatchSegmentKeyRequestMultiError is an error wrapping multiple validation
// errors returned by MatchSegmentKeyRequest.ValidateAll() if the designated
// constraints aren't met.
type MatchSegmentKeyRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m MatchSegmentKeyRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m MatchSegmentKeyRequestMultiError) AllErrors() []error { return m }

// MatchSegmentKeyRequestValidationError is the validation error returned by
// MatchSegmentKeyRequest.Validate if the designated constraints aren't met.
type MatchSegmentKeyRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e MatchSegmentKeyRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MatchSegmentKeyRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MatchSegmentKeyRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MatchSegmentKeyRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MatchSegmentKeyRequestValidationError) ErrorName() string {
	return "MatchSegmentKeyRequestValidationError"
}

// Error satisfies the builtin error interface
func (e MatchSegmentKeyRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sMatchSegmentKeyRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = MatchSegmentKeyRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = MatchSegmentKeyRequestValidationError{}

// Validate checks the field values on MatchSegmentKeyResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *MatchSegmentKeyResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on MatchSegmentKeyResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// MatchSegmentKeyResponseMultiError, or nil if none found.
func (m *MatchSegmentKeyResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *MatchSegmentKeyResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetResults() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, MatchSegmentKeyResponseValidationError{
						field:  fmt.Sprintf("Results[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return MatchSegmentKeyResponseValidationError{
					field:  fmt.Sprintf("Results[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return MatchSegmentKeyResponseMultiError(errors)
	}

	return nil
}

// MatchSegmentKeyResponseMultiError is an error wrapping multiple validation
// errors returned by MatchSegmentKeyResponse.ValidateAll() if the designated
// constraints aren't met.
type MatchSegmentKeyResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m MatchSegmentKeyResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m MatchSegmentKeyResponseMultiError) AllErrors() []error { return m }

// MatchSegmentKeyResponseValidationError is the validation error returned by
// MatchSegmentKeyResponse.Validate if the designated constraints aren't met.
type MatchSegmentKeyResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e MatchSegmentKeyResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MatchSegmentKeyResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MatchSegmentKeyResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MatchSegmentKeyResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MatchSegmentKeyResponseValidationError) ErrorName() string {
	return "MatchSegmentKeyResponseValidationError"
}

// Error satisfies the builtin error interface
func (e MatchSegmentKeyResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sMatchSegmentKeyResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = MatchSegmentKeyResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = MatchSegmentKeyResponseValidationError{}
